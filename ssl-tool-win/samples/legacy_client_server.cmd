...
REM Elasticsearch
call run_additional.cmd -servicename elasticsearch -alias elasticsearch_client -role client -rootcapass kT9X6oe68t -keysize 2048 -keystoretype JKS -keystorepass kT9X6oe68t -truststoretype JKS -truststorepass kT9X6oe68t -certdname "/C=GB/ST=UK/L=Maidenhead/O=Alfresco Software Ltd./OU=Unknown/CN=Elasticsearch Client" -alfrescoformat %ALFRESCO_FORMAT%
call run_additional.cmd -servicename elasticsearch -alias elasticsearch_server -role server -rootcapass kT9X6oe68t -keysize 2048 -keystoretype JKS -keystorepass kT9X6oe68t -truststoretype JKS -truststorepass kT9X6oe68t -certdname "/C=GB/ST=UK/L=Maidenhead/O=Alfresco Software Ltd./OU=Unknown/CN=Elasticsearch Server" -servername "localhost,elasticsearch" -alfrescoformat %ALFRESCO_FORMAT%
REM Live Indexing
