...
#Elasticsearch
bash ${SCRIPT_DIR}/../run_additional.sh -servicename elasticsearch -alias elasticsearch_client -role client -rootcapass kT9X6oe68t -keysize 2048 -keystoretype JCEKS -keystorepass kT9X6oe68t -truststoretype JCEKS -truststorepass kT9X6oe68t -certdname "/C=GB/ST=UK/L=Maidenhead/O=Alfresco Software Ltd./OU=Unknown/CN=Elasticsearch Client" -alfrescoformat $ALFRESCO_FORMAT
bash ${SCRIPT_DIR}/../run_additional.sh -servicename elasticsearch -alias elasticsearch_server -role server -rootcapass kT9X6oe68t -keysize 2048 -keystoretype JCEKS -keystorepass kT9X6oe68t -truststoretype JCEKS -truststorepass kT9X6oe68t -certdname "/C=GB/ST=UK/L=Maidenhead/O=Alfresco Software Ltd./OU=Unknown/CN=Elasticsearch Server" -servername localhost,elasticsearch -alfrescoformat $ALFRESCO_FORMAT
#Live Indexing
bash ${SCRIPT_DIR}/../run_additional.sh -servicename liveIndexing -alias liveIndexing_client -role client -rootcapass kT9X6oe68t -keysize 2048 -keystoretype JCEKS -keystorepass kT9X6oe68t -truststoretype JCEKS -truststorepass kT9X6oe68t -certdname "/C=GB/ST=UK/L=Maidenhead/O=Alfresco Software Ltd./OU=Unknown/CN=Live Indexing Client" -alfrescoformat $ALFRESCO_FORMAT
bash ${SCRIPT_DIR}/../run_additional.sh -servicename liveIndexing -alias liveIndexing_server -role server -rootcapass kT9X6oe68t -keysize 2048 -keystoretype JCEKS -keystorepass kT9X6oe68t -truststoretype JCEKS -truststorepass kT9X6oe68t -certdname "/C=GB/ST=UK/L=Maidenhead/O=Alfresco Software Ltd./OU=Unknown/CN=Live Indexing Server" -servername localhost,live-indexing -alfrescoformat $ALFRESCO_FORMAT
